...
public class Window {
	...
	protected void createContents() {
		...
		Button btnLearnMore_1 = new Button(shlVirtue, SWT.NONE);
		btnLearnMore_1.setText("Learn more");
		btnLearnMore_1.setBounds(132, 783, 105, 27);
		formToolkit.adapt(btnLearnMore_1, true, true);
